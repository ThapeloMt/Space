 *The Main Program
       ...
       SELECT HISTO-KEY ASSIGN TO 'HISTORY-KEY.dat'
           ORGANIZATION IS INDEXED
            ACCESS MODE IS DYNAMIC
             RECORD KEY IS HISTORY-ID
       ...
       01 WS-HIST-COUNTER        PIC 9(10) VALUE 1.
       01 WS-HIST-COUNTER2       PIC 9(10) VALUE 1.
       01 WS-HIS-SUM             PIC 9(10) VALUE 0.

       01 WS-HISTO-RECORD.
        05 WS-HISTORY-ID      PIC 9(5).
        05 WS-HISTORY-KEY     PIC 9(5).
       ...
       WRITE-TRANSACTION-HISTORY.
          ...
          OPEN INPUT TRANSACTION-FILE
           ...
           READ HISTORY-FILE INTO WS-HISTO-RECORD
              AT END
                CONTINUE
               NOT AT END
                MOVE WS-HISTORY-KEY TO WS-HIST-COUNTER
           END-READ
           ...
           OPEN I-O HISTO-KEY
              ...
              AT END
                CONTINUE
               NOT AT END
                MOVE WS-HISTORY-KEY TO WS-HIS-SUM
             END-READ
               DISPLAY WS-HIS-SUM

              COMPUTE WS-HIS-SUM = WS-HIS-SUM + WS-HIST-COUNTER
              MOVE WS-HIS-SUM TO HISTORY-KEY
              REWRITE HISTO-RECORD
              END-REWRITE
              CLOSE HISTO-KEY
